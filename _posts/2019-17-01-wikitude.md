...
After reviewing six different AR-platforms and testing most of them ([see here for details](https://scriptotek.github.io/ar-project/)), we decided on Wikitude and started the process of fleshing out a prototype based on the possibilities and limitations of the chosen platform. In this blog post we write mainly about the design and functionality of the prototype app, but if your want to read more in depth about our experiences with the platform you can read ([this post](https://scriptotek.github.io/ar-project/)), but we recommend reading this post first.
